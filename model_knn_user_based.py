# Model fitting: Collaborative (user-based) Filtering with k-nearest neighbors
...
def main():
    ...
    # fit the model
    user_knn = KNNBasic(k=3, min_k=1, sim_options={'name': 'cosine', 'user_based': True})
